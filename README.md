...
```bash
go get github.com/eanavitarte/go-wordpress
```
...
Parts of this libreary are an adoption of a previously orphaned project maintained by [`qorpress`](https://github.com/qorpress/go-wordpress). Thanks to their grateful work and contributions.

Parts of this library were inspired (if not outright copied) from Google's excellent [`go-github`](https://github.com/google/go-github) library.
